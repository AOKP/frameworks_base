        ...
        if (targetKey.startsWith("app:")) {
        	...
        	if(am != null){
				if(am.getRingerMode() != AudioManager.RINGER_MODE_SILENT) {
					...
					am.setRingerMode(AudioManager.RINGER_MODE_NORMAL);
					ToneGenerator tg = new ToneGenerator(AudioManager.STREAM_NOTIFICATION, (int)(ToneGenerator.MAX_VOLUME * 0.75));
					if(tg != null){
						tg.startTone(ToneGenerator.TONE_PROP_BEEP);
					}
				}
    ...
    private void setDrawables() {
        ...
        for (int i = 0; i < targetActivities.size(); i++)
            if (targetActivities.get(i) == null || targetActivities.get(i).equals("") || targetActivities.get(i).equals("none")) {
                ...
                storedDraw.add(new TargetDrawable(mResources, mResources.getDrawable(R.drawable.ic_navbar_silent)));
            } else if (targetActivities.get(i).equals("ring_vib_silent")) {
                storedDraw.add(new TargetDrawable(mResources, mResources.getDrawable(R.drawable.ic_navbar_ring_vib_silent)));
