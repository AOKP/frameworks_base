...
import com.android.internal.util.aokp.AwesomeHelpers;
       ...
       final Runnable SetLongPress = new Runnable () {
            public void run() {
                if (!mSearchPanelLock) {
                    ...
                    maybeSkipKeyguard();
                    AwesomeHelpers.launchAction(mContext, longList.get(mTarget));
        ...
        public void onTrigger(View v, final int target) {
            ...
            if (!mLongPress) {
                if (ACTION_ASSIST.equals(intentList.get(target))) {
                    ...
                    maybeSkipKeyguard();
                    AwesomeHelpers.launchAction(mContext, intentList.get(target));
                }
                mHandler.removeCallbacks(SetLongPress);
            }
        }
