...
public class GestureCatcherView extends LinearLayout{
    ...
    public GestureCatcherView(Context context, AttributeSet attrs, BaseStatusBar sb) {
        ...
        mConstant = res.getDimensionPixelSize(R.dimen.drag_handle_constant);
        mMultiplier = res.getDimensionPixelSize(R.dimen.drag_handle_multiplier);
    ...
    public void setWeights() {
        //just a test
        LayoutParams DragParams = (LayoutParams) mDragButton.getLayoutParams();
        DragParams.width = (mWidth * mMultiplier) + mConstant;
        mDragButton.setLayoutParams(DragParams);
    }
   ...
   protected void updateSettings() {
        ...
        mWidth = Settings.System.getInt(cr, Settings.System.DRAG_HANDLE_WEIGHT, 0);
        setWeights();
    }
}
