...
public class TorchToggle extends Toggle {
    ...
    public TorchToggle(Context context) {
        ...
        mContext = context;
        mIsTorchOn = Settings.System.getBoolean(mContext.getContentResolver(), KEY_TORCH_ON, false);
        updateState();
    }
    ...
    protected void onCheckChanged(boolean isChecked) {
        ...
        Settings.System.putBoolean(mContext.getContentResolver(), KEY_TORCH_ON, mIsTorchOn);
    }
