...
//                }
    ...
    public void updateSettings() {
        ...
        mUserToggles = Settings.System.getString(resolver, Settings.AOKP.QUICK_TOGGLES);
        if(mUserToggles == null) {
            mUserToggles = "";
        }
        int columnCount = Settings.System.getInt(resolver, Settings.AOKP.QUICK_TOGGLES_PER_ROW,
                mContext.getResources().getInteger(R.integer.quick_settings_num_columns));

        mStyle = Settings.System.getInt(resolver, Settings.AOKP.TOGGLES_STYLE,
