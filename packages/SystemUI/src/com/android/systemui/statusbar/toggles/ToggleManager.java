...
//            if(((LocationManager)mContext.getSystemService(Context.LOCATION_SERVICE)).
            ...
            if(((TelephonyManager)mContext.getSystemService(Context.TELEPHONY_SERVICE)).getPhoneType() 
