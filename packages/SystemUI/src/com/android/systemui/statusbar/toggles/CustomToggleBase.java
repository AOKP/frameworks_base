...
public class CustomToggleBase extends BaseToggle {
    ...
    public Drawable userIcon(int toggle, int state) {
        getToggle(toggle);
        String iconUri = "";
        Drawable icon = null;
    ...
    public String toggleText(int toggle, int state) {
        getToggle(toggle);
        String text = NavBarHelpers.getProperSummary(mContext, "**null**".equals(mClickActions.get(state))
                ? mLongActions.get(state) : mClickActions.get(state));
        return text;
    }
...
public class CustomTarget {
    ...
    public CustomTarget(final String sClick, final String lClick,
            final String cIcon, final String cText, final int cState) {

        cText = (TextView) mView.findViewById(R.id.label);
        cText.setText(NavBarHelpers.getProperSummary(mContext, "**null**".equals(sClick) ? lClick : sClick));

        cIcon = (ImageButton) mView.findViewById(R.id.icon);
        Drawable newIcon = NavBarHelpers.getIconImage(mContext, "**null**");
        if (!"**null**".equals(cIcon)) {
            newIcon = NavBarHelpers.getIconImage(mContext, "**null**".equals(sClick) ? lClick : sClick);
        ...
        cIcon.setImageDrawable(newIcon);
    }
}     */
