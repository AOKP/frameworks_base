...
public class XzibitToggler {
    ...
    private void setupTraditional() {
        ...
        if (mContainers[STYLE_TRADITIONAL] != null) {
            updateToggleList();
            log("setting up " + mToggles.size() + " traditional toggles");
    ...
    public void updateSettings() {
        ...
        mStyle = XzibitToggler.STYLE_TILE;
    ...
    public static int getTextSize(Context c) {
        int columnCount = Settings.System.getInt(c.getContentResolver(), Settings.System.QUICK_TOGGLES_PER_ROW,
