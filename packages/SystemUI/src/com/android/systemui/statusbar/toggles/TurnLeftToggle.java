...
public class TurnLeftToggle extends StatefulToggle {
    ...
    protected void updateView() {
        ...
        setIcon(lock ? R.drawable.ic_qs_turn_left_locked : R.drawable.ic_qs_turn_left);
        setLabel(R.string.quick_settings_turn_left);
    ...
    private void rotateScreen() {
        try {
            ...
            int newRotation = (4 + wm.getRotation() - 1) % 4;
