...
public class NavigationBarView extends LinearLayout {
    ...
    private void makeBar() {
        ...
        if(bg instanceof ColorDrawable) {
            BackgroundAlphaColorDrawable bacd = new BackgroundAlphaColorDrawable(((ColorDrawable) bg).getColor());
            if(mNavigationBarColor > 0 && mNavigationBarColor != bacd.getBgColor()) {
                bacd.setBgColor(mNavigationBarColor);
            }
            setBackground(bacd);
        }
