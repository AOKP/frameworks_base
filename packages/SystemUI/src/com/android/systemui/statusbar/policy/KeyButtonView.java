...
public class KeyButtonView extends ImageView {
    ...
    public void setButtonActions(AwesomeButtonInfo actions) {
        ...
        if(mActions.singleAction != null && mActions.singleAction.isEmpty()) {
            mActions.singleAction = null;
        }
        if(mActions.doubleTapAction != null && mActions.doubleTapAction.isEmpty()) {
            mActions.doubleTapAction = null;
        }
        if(mActions.longPressAction != null && mActions.longPressAction.isEmpty()) {
            mActions.longPressAction = null;
        }
