...
public class ActiveDisplayView extends FrameLayout {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.SCREEN_BRIGHTNESS_MODE), false, this);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
        ...
        public void update() {
            ...
            int brightnessMode = Settings.AOKP.getInt(
                    resolver, Settings.AOKP.SCREEN_BRIGHTNESS_MODE, -1);
    ...
    private void setBrightness(float brightness) {
        ...
        mBrightnessMode = Settings.AOKP.getInt(resolver, Settings.AOKP.SCREEN_BRIGHTNESS_MODE,
                Settings.AOKP.SCREEN_BRIGHTNESS_MODE_AUTOMATIC);
        if (mBrightnessMode != Settings.AOKP.SCREEN_BRIGHTNESS_MODE_AUTOMATIC) {
            mUserBrightnessLevel = Settings.AOKP.getInt(resolver, Settings.AOKP.SCREEN_BRIGHTNESS,
            ...
            Settings.AOKP.putInt(resolver,
                    Settings.AOKP.SCREEN_BRIGHTNESS_MODE,
                    Settings.AOKP.SCREEN_BRIGHTNESS_MODE_MANUAL);
            try {
    ...
    private void restoreBrightness() {
        if (mUserBrightnessLevel < 0 || mBrightnessMode < 0
                || mBrightnessMode == Settings.AOKP.SCREEN_BRIGHTNESS_MODE_AUTOMATIC) {
            return;
        }
        final ContentResolver resolver = mContext.getContentResolver();
        try {
