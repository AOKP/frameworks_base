...
public class ActiveDisplayView extends FrameLayout {
    ...
    private OnTriggerListener mOnTriggerListener = new OnTriggerListener() {
        ...
        public void onTargetChange(final View v, final int target) {
            // just a stub - bic spry!!
        }
    ...
    private void handleShowTime() {
        mCurrentNotificationIcon.setImageResource(android.R.color.transparent);
...
>>>>>>> ec53341... Active Display: Add always show pocket mode. [1/2]
    }
