...
public class Traffic extends TextView {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.AOKP.getUriFor(Settings.AOKP.STATUS_BAR_TRAFFIC), false, this);
        }
    ...
    private void updateSettings() {
        ContentResolver resolver = mContext.getContentResolver();
        showTraffic = (Settings.AOKP.getInt(resolver,
            Settings.AOKP.STATUS_BAR_TRAFFIC, 1) == 1);
