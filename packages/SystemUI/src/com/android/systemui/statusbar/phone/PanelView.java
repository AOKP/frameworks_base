                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    switch (event.getActionMasked()) {
                        case MotionEvent.ACTION_DOWN:
                            ...
                            if (mExpandedHeight == 0) {
                                ...
                                if(!mAutobrightnessEnabled && mStatusBarSliderEnabled)
                                    mHandler.postDelayed(mSetShouldReact, 200);
                            }
                            break;
                        ...
                        case MotionEvent.ACTION_CANCEL:
                            if(!mAutobrightnessEnabled && mStatusBarSliderEnabled && mTracking) {
                                postDelayed(mSaveBrightness, 200);
                            }
                            mShouldReactToBrightnessSlider = false;
                            mFinalTouchY = y;
                            mTracking = false;
...
//        setLayoutParams(lp);
    ...
    private void updateUseSlider() {
        ...
        Log.e(TAG, "updateUseSlider(): " + mStatusBarSliderEnabled);
    }
}
