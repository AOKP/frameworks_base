...
//        ((ImageView)getRecentsButton()).setImageDrawable(mVertical ? mRecentLandIcon : mRecentIcon);
    ...
    private void setupNavigationButtons() {
        readUserConfig();
        boolean addOutsideSeparators = mNavButtons.size() <= 3;
        ...
        for (int i = 0; i <= 1; i++) {
            ...
            for (int j = 0; j < mNavButtons.size(); j++) {
                ...
                button.setLayoutParams(getLayoutParams(landscape, mButtonWidth, addOutsideSeparators ? 0f : 1f));
                ...
                if (addOutsideSeparators && j != (mNavButtons.size() - 1)) {
                    ...
                    addSeparator(navButtons, landscape, separatorSize, 1f);
                    addSeparator(lightsOut, landscape, separatorSize, 1f);
                }
            }
