...
public class NavigationBarView extends LinearLayout {
    ...
    private void setupNavigationButtons() {
        ...
        for (int i = 0; i <= 1; i++) {
            ...
            if (mTablet) {
                // needs dis to offset the menu button. it is what it is
            ...
            for (int j = 0; j < mNavButtons.size(); j++) {
                ...
                if (!mTablet && addOutsideSeparators && j != (mNavButtons.size() - 1)) {
...
//        if (mTablet) { // this is either a mTablet of Phablet.  Need to stay at Rot_0
//            mCurrentView = mRotatedViews[Surface.ROTATION_0];
//        } else {
