...
public class PhoneStatusBar extends BaseStatusBar {
    ...
    private float mFlingGestureMaxOutputVelocityPx;
            // how fast can it really go? (should be a little
    ...
    private boolean mSuppressStatusBarDrags;
            // while a cling is up, briefly deaden the bar to give things time to settle
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        if (ENABLE_INTRUDERS) {
            mIntruderAlertView =
                    (IntruderAlertView) View.inflate(context, R.layout.intruder_alert, null);
            mIntruderAlertView.setVisibility(View.GONE);
            mIntruderAlertView.setBar(this);
        }
        if (MULTIUSER_DEBUG) {
            mNotificationPanelDebugText =
                    (TextView) mNotificationPanel.findViewById(R.id.header_debug_info);
        ...
        mSbBatteryController =
                (SbBatteryController) mStatusBarView.findViewById(R.id.battery_cluster);
        ...
        if (mHasSettingsPanel) {
            ...
            if (mHasFlipSettings) {
                ...
                if (settings_stub != null) {
                    ...
                    mSettingsPanel =
                            (SettingsPanelView) mStatusBarWindow.findViewById(R.id.settings_panel);
                }

                if (mSettingsPanel != null) {
                    if (!ActivityManager.isHighEndGfx()) {
                        mSettingsPanel.setBackground(
                                new FastColorDrawable(context.getResources().getColor(
                                        R.color.notification_panel_solid_background)));
                    }
                }
            }
            ...
            mToggleManager
                    .setControllers(mBluetoothController, mNetworkController, mBatteryController,
                            mLocationController, null);
            mAokpSwipeRibbonLeft
                    .setControllers(mBluetoothController, mNetworkController, mBatteryController,
                            mLocationController, null);
            mAokpSwipeRibbonRight
                    .setControllers(mBluetoothController, mNetworkController, mBatteryController,
                            mLocationController, null);
            if (mToggleStyle == ToggleManager.STYLE_SCROLLABLE) {
                mToggleManager.setContainer(
                        (LinearLayout) mNotificationPanel.findViewById(R.id.quick_toggles),
...
//        }
    ...
    private void hideNavBar() {
        if (mNavigationBarView != null && !mLockscreenOn) {
            try {
                ...
                // we are probably in a state where NavBar has been created,
                // but not actually added to the window
    ...
    public void addNotification(IBinder key, StatusBarNotification notification) {
        ...
        if (ENABLE_INTRUDERS && (
            ...
            if (notification.notification.intruderView == null) {
                Slog.e(TAG, notification.notification.toString() + " wanted to intrude but
                intruderView was null");
                return;
            }
            ...
            mIntruderAlertView.applyIntruderContent(notification.notification.intruderView,
            listener);
    ...
    protected void updateCarrierLabelVisibility(boolean force) {
        ...
        final boolean makeVisible =
                !(emergencyCallsShownElsewhere && mNetworkController.isEmergencyOnly())
                        && mPile.getHeight() <
                        (mNotificationPanel.getHeight() - mCarrierLabelHeight -
    ...
    public void disable(int state) {
        ...
        flagdbg.append(
                ((state & StatusBarManager.DISABLE_NOTIFICATION_ICONS) != 0) ? "ICONS" : "icons");
    ...
    void makeExpandedVisible(boolean revealAfterDraw) {
        ...
        // This is only possible to do atomically because the status bar is at the top of the
        // screen!
        WindowManager.LayoutParams lp =
...
//            mHandler.post(mStartRevealAnimation);
    ...
    public void updateRibbonTargets() {
        ...
        if (mRibbonQS != null) {
            ...
            mRibbonQS.addView(AokpRibbonHelper.getRibbon(mContext,
                    ...
                    Settings.System.getBoolean(cr,
                            Settings.System.ENABLE_RIBBON_TEXT[AokpRibbonHelper.QUICK_SETTINGS],
                            true),
                    ...
                    Settings.System.getBoolean(cr,
                            Settings.System.RIBBON_ICON_VIBRATE[AokpRibbonHelper.QUICK_SETTINGS],
                            true),
                    Settings.System.getBoolean(cr,
                            Settings.System.RIBBON_ICON_COLORIZE[AokpRibbonHelper.QUICK_SETTINGS],
                            false), 0));
        }
        ...
        mRibbonNotif.addView(AokpRibbonHelper.getRibbon(mContext,
                ...
                Settings.System.getBoolean(cr,
                        Settings.System.RIBBON_ICON_COLORIZE[AokpRibbonHelper.NOTIFICATIONS],
                        false), 0));
    }
    ...
    public void showCling() {
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                makeExpandedVisible(
                        true); // enforce visibility in case the shade is still animating closed
                animateExpandNotificationsPanel();
    ...
    public void updateExpandedViewPos(int thingy) {
        ...
        FrameLayout.LayoutParams lp =
                (FrameLayout.LayoutParams) mNotificationPanel.getLayoutParams();
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_CLOSE_SYSTEM_DIALOGS.equals(action)) {
                ...
                if (DEBUG) {
                    Slog.v(TAG,
                            "configuration changed: " + mContext.getResources().getConfiguration());
                }
                ...
                if (mNavigationBarView != null && mNavigationBarView.mDelegateHelper != null) {
                    // if We are in Landscape/Phone Mode then swap the XY coordinates for NaVRing
                    // Swipe
                ...
                // work around problem where mDisplay.getRotation() is not stable while screen is
                // off (bug 7086018)
                repositionNavigationBar();
...
//            Slog.d(TAG, "size=" + newIconSize + " padding=" + newIconHPadding);
        ...
        mNotificationPanelMinHeightFrac =
                res.getFraction(R.dimen.notification_panel_min_height_frac, 1, 1);
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_SHORT[AokpRibbonHelper.NOTIFICATIONS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_LONG[AokpRibbonHelper.NOTIFICATIONS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_ICONS[AokpRibbonHelper.NOTIFICATIONS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.ENABLE_RIBBON_TEXT[AokpRibbonHelper.NOTIFICATIONS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TEXT_COLOR[AokpRibbonHelper.NOTIFICATIONS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_SPACE[AokpRibbonHelper.NOTIFICATIONS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_VIBRATE[AokpRibbonHelper.NOTIFICATIONS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_SHORT[AokpRibbonHelper.QUICK_SETTINGS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_LONG[AokpRibbonHelper.QUICK_SETTINGS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_ICONS[AokpRibbonHelper.QUICK_SETTINGS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.ENABLE_RIBBON_TEXT[AokpRibbonHelper.QUICK_SETTINGS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_SIZE[AokpRibbonHelper.QUICK_SETTINGS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_SPACE[AokpRibbonHelper.QUICK_SETTINGS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_VIBRATE[AokpRibbonHelper.QUICK_SETTINGS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_COLORIZE[AokpRibbonHelper.QUICK_SETTINGS]), false,
                    this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TEXT_COLOR[AokpRibbonHelper.QUICK_SETTINGS]), false,
                    this);
        }
    ...
    protected void updateSettings() {
        ...
        mAutoHideTimeOut =
                Settings.System.getInt(cr, Settings.System.NAV_HIDE_TIMEOUT, mAutoHideTimeOut);
        mToggleStyle =
                Settings.System.getInt(cr, Settings.System.TOGGLES_STYLE, ToggleManager.STYLE_TILE);
        if (mNavBarAutoHide) {
            setupAutoHide();
