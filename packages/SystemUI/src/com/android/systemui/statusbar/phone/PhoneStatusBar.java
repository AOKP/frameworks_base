...
//            Log.d(TAG, "size=" + newIconSize + " padding=" + newIconHPadding);
    ...
    private void updateSettings() {
        ...
        //Default to mWindowManagerService.hasNavigationBar() but converted to int
        int hasNav = (mWindowManagerService.hasNavigationBar()) ? 1 : 0;
        mWantsNavigationBar = Settings.AOKP.getInt(cr, Settings.AOKP.ENABLE_NAVIGATION_BAR, hasNav) == 1;
    }
