...
//            mHandler.post(mStartRevealAnimation);
    ...
    public void setNavigationIconHints(int hints) {
        ...
        mAokpSwipeRibbonBottom.setNavigationIconHints(hints);
        mAokpSwipeRibbonLeft.setNavigationIconHints(hints);
        mAokpSwipeRibbonRight.setNavigationIconHints(hints);
