   ...
   // public static final String BT_TETHER_TOGGLE = "BTTETHER";
    ...
    private QuickSettingsTileView getTile(int tile, ViewGroup parent, LayoutInflater inflater) {
        ...
        switch (tile) {
            ...
            case FCHARGE_TILE:
                ...
                mHandler.post(mRestoreFChargeState);
                break;
    ...
    private ArrayList<String> getCustomUserTiles() {
        ...
        for (String toggle : splitter) {
            if(FCHARGE_TOGGLE.equals(toggle) && (mFastChargePath == null || mFastChargePath.isEmpty())) {
                continue;
            }
            tiles.add(toggle);
        }
    ...
    final Runnable mRestoreFChargeState = new Runnable() {
        public void run() {
