...
class QuickSettings {
   ...
   // public static final String BT_TETHER_TOGGLE = "BTTETHER";
    ...
    private QuickSettingsTileView getTile(int tile, ViewGroup parent, LayoutInflater inflater) {
        ...
        final int tileBG = (mUseDefaultTheme ? R.drawable.qs_tile_background : R.drawable.qs_tile_background_light);
        final int tileText = (mUseDefaultTheme ? R.color.quicksettings_text_color_dark : R.color.quicksettings_text_color_light);
        final int tileTextBG = (mUseDefaultTheme ? R.color.quicksettings_text_background_dark : R.color.quicksettings_text_background_light);
        ...
        switch (tile) {
            case USER_TILE:
                ...
                quick.setBackgroundResource(tileBG);
                ...
                mModel.addUserTile(quick, new QuickSettingsModel.RefreshCallback() {
                    ...
                    public void refreshView(QuickSettingsTileView view, State state) {
                        ...
                        tv.setTextColor(tileText);
                        tv.setBackgroundColor(tileTextBG);
    ...
    private void addTemporaryTiles(final ViewGroup parent, final LayoutInflater inflater) {
        ...
        QuickSettingsTileView alarmTile = (QuickSettingsTileView)
                inflater.inflate(R.layout.quick_settings_tile, parent, false);
        alarmTile.setBackgroundResource(tileBG);
        ...
        QuickSettingsTileView wifiDisplayTile = (QuickSettingsTileView)
                inflater.inflate(R.layout.quick_settings_tile, parent, false);
        wifiDisplayTile.setBackgroundResource(tileBG);
        ...
        QuickSettingsTileView bugreportTile = (QuickSettingsTileView)
                inflater.inflate(R.layout.quick_settings_tile, parent, false);
        bugreportTile.setBackgroundResource(tileBG);
