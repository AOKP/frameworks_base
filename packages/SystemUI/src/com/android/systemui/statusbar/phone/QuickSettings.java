...
public class QuickSettings {
   ...
   // private static final int BT_TETHER_TILE = 23;
    ...
    private static final int STATUSBAR_TILE = 25;
    ...
    private QuickSettingsTileView getTile(int tile, ViewGroup parent, LayoutInflater inflater) {
        ...
        switch (tile) {
            ...
            case STATUSBAR_TILE:
                quick = (QuickSettingsTileView)
                        inflater.inflate(R.layout.quick_settings_tile, parent, false);
                quick.setContent(R.layout.quick_settings_tile_statusbar_hide, inflater);
                quick.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                    boolean StatusbarState = Settings.System.getBoolean(mContext.getContentResolver(),
                        ...
                        Settings.System.putBoolean(mContext.getContentResolver(),
                                 Settings.System.NAVIGATION_BAR_STATUS_SHOW_NOW, !StatusbarState);
                    }
                });
                quick.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
                        ...
                        intent.setComponent(ComponentName.
                                unflattenFromString("com.aokp.romcontrol/.fragments.UserInterface"));
                        intent.addCategory("android.intent.category.LAUNCHER");
                        startSettingsActivity(intent);
                    }
                });
                mModel.addStatusBarHideTile(quick, new QuickSettingsModel.RefreshCallback() {
                    @Override
                    public void refreshView(QuickSettingsTileView view, State state) {
