...
class QuickSettings {
   ...
   // public static final String BT_TETHER_TOGGLE = "BTTETHER";
    ...
    private void setFastCharge(final boolean on) {
        ...
        mContext.sendOrderedBroadcast(fastChargeIntent, null, new BroadcastReceiver() {
            @Override
            public void onReceive(Context context, Intent intent) {
                Prefs.setLastFastChargeState(mContext, on);
                mHandler.post(refreshFastChargeTile);
            }
    ...
    final Runnable refreshFastChargeTile = new Runnable() {
        public void run() {
