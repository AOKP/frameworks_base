        ...
        if (mTabletui) {
            if (mNavRingAmount > 3) {
                mSearchPanelView = (SearchPanelView) LayoutInflater.from(mContext).inflate(
                        mLefty ? R.layout.status_bar_search_panel_five_lefty_tablet :
                            R.layout.status_bar_search_panel_five_tablet , tmpRoot, false);
            } else {
                mSearchPanelView = (SearchPanelView) LayoutInflater.from(mContext).inflate(
            ...
            if (mNavRingAmount > 3) {
                mSearchPanelView = (SearchPanelView) LayoutInflater.from(mContext).inflate(
                        mLefty ? R.layout.status_bar_search_panel_five_lefty :
