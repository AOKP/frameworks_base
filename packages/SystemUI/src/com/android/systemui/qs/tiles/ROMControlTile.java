...
public class ROMControlTile extends QSTile<QSTile.BooleanState> {
    ...
    private static final Intent MGERRIT = new Intent().setComponent(new ComponentName(
            "com.jbirdvegas.mgerrit", "com.jbirdvegas.mgerrit.TheApplication"));
    ...
    public void handleLongClick() {
      mHost.startActivityDismissingKeyguard(MGERRIT);
    }
