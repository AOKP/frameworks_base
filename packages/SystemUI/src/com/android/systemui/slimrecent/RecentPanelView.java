...
public class RecentPanelView {
    ...
    private void handleFavoriteEntry(TaskDescription td) {
        ...
        final String favorites = Settings.AOKP.getStringForUser(
                    resolver, Settings.AOKP.RECENT_PANEL_FAVORITES,
        ...
        Settings.AOKP.putStringForUser(
                resolver, Settings.AOKP.RECENT_PANEL_FAVORITES,
                entryToSave,
                UserHandle.USER_CURRENT);
    }
    ...
    protected void loadTasks() {
        ...
        final String favorites = Settings.AOKP.getStringForUser(
                mContext.getContentResolver(), Settings.AOKP.RECENT_PANEL_FAVORITES,
                UserHandle.USER_CURRENT);
