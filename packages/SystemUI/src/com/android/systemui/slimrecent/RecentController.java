    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.RECENT_PANEL_GRAVITY),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.RECENT_PANEL_SCALE_FACTOR),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.RECENT_PANEL_EXPANDED_MODE),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.RECENT_PANEL_SHOW_TOPMOST),
                    false, this, UserHandle.USER_ALL);
            update();
        }
        ...
        public void update() {
            ...
            // Get user gravity.
            mUserGravity = Settings.AOKP.getIntForUser(
                    resolver, Settings.AOKP.RECENT_PANEL_GRAVITY, 0,
                    UserHandle.USER_CURRENT);
            mUserGravity = (mUserGravity == 1) ? Gravity.LEFT : Gravity.RIGHT;

            // Set main gravity and background images.
            setGravityAndImageResources();

            // Get user scale factor.
            float scaleFactor = Settings.AOKP.getIntForUser(
                    resolver, Settings.AOKP.RECENT_PANEL_SCALE_FACTOR, 100,
            ...
            if (mRecentPanelView != null) {
                ...
                mRecentPanelView.setExpandedMode(Settings.AOKP.getIntForUser(
                    resolver, Settings.AOKP.RECENT_PANEL_EXPANDED_MODE,
                    mRecentPanelView.EXPANDED_MODE_AUTO,
                    UserHandle.USER_CURRENT));
                mRecentPanelView.setShowTopTask(Settings.AOKP.getIntForUser(
                    resolver, Settings.AOKP.RECENT_PANEL_SHOW_TOPMOST, 0,
