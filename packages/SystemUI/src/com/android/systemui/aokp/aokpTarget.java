...
public class aokpTarget {
    ...
    public final String ACTION_BACK = "**back**";
    public final String ACTION_SCREENSHOT = "**screenshot**";
    public final String ACTION_MENU = "**menu**";
    public final String ACTION_POWER = "**power**";
    public final String ACTION_NOTIFICATIONS = "**notifications**";
    public final String ACTION_RECENTS = "**recents**";
    public final String ACTION_IME = "**ime**";
    public final String ACTION_KILL = "**kill**";
    public final String ACTION_CUSTOM = "**custom**";
