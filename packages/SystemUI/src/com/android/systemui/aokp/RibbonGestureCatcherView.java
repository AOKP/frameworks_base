...
public class RibbonGestureCatcherView extends LinearLayout {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.AOKP.getUriFor(SETTINGS_AOKP[AokpRibbonHelper.HANDLE_OPACITY]), false, this);
    ...
    protected void updateSettings() {
        ...
        mDragButtonOpacity = Settings.AOKP.getInt(cr, SETTINGS_AOKP[AokpRibbonHelper.HANDLE_OPACITY], 0);
        ...
        mLongPressAction = Settings.System.getString(cr, SETTINGS_AOKP[AokpRibbonHelper.LONG_PRESS]);
        ...
        vib = Settings.AOKP.getBoolean(cr, SETTINGS_AOKP[AokpRibbonHelper.HANDLE_VIBRATE], false);
        mLocation = Settings.System.getInt(cr, SETTINGS_AOKP[AokpRibbonHelper.HANDLE_LOCATION], 0);
        updateLayout();
    }
}
