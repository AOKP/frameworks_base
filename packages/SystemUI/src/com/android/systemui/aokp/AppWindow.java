...
public class AppWindow extends LinearLayout {
    ...
    public void createWindowView() {
        ...
        mCloseButton.getBackground().setAlpha(0);
        ...
        if (mTextColor != -1) {
            ...
            mWindowDividerTop.setColorFilter(mTextColor);
            mWindowDividerBottom.setColorFilter(mTextColor);
