...
public class AokpSwipeRibbon extends LinearLayout {
    ...
    public void createRibbonView() {
        ...
        if (mNavBarShowing) {
           /* int adjustment = Settings.System.getInt(
                mContext.getContentResolver(), Settings.System.NAVIGATION_BAR_HEIGHT,
 ...
 /*       BackgroundAlphaColorDrawable bacd = new BackgroundAlphaColorDrawable(
    ...
    private void setupRibbon() {
        ...
        if (mLocation.equals("bottom")) {
            ...
            hsv = AokpRibbonHelper.getRibbon(mContext,
                shortTargets, longTargets, customIcons, mText, mSize);
   ...
   protected void updateSettings() {
        ...
        mNavBarShowing = !navAutoHide && (NavBarEnabled || hasNavBarByDefault);
        mEnableSides[0] = mEnableSides[0] && mNavBarShowing;
        createRibbonView();
    }
