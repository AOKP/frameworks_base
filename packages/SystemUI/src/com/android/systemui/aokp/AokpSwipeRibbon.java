...
public class AokpSwipeRibbon extends LinearLayout implements OnItemClickListener {
    ...
    private View mContainerFrame;
    private Animation mAnimationIn;
    private Animation mAnimationOut;
    private int mHideTimeOut, animationIn, animationOut, mAnim, visible, mDisabledFlags;
    ...
    public void createRibbonView() {
        ...
        mContainerFrame = (View) ribbonView.findViewById(R.id.ribbon_main);
        mRibbon = (ListView) ribbonView.findViewById(R.id.ribbon_list);
        setupRibbon();
        setAnimation();
        mAnimationIn = PlayInAnim();
        mAnimationOut = PlayOutAnim();
        mPopupView.addView(ribbonView, backgroundParams);
   ...
   protected void updateSettings() {
        ...
        mEnabled = Settings.AOKP.getBoolean(cr, SETTINGS_AOKP[AokpRibbonHelper.ENABLE_RIBBON], true);
        mItems.clear();
        ...
        //remove before merge testing only
        String[] actions = NavRingHelpers.getNavRingActions();
        for (String action : actions) {
            mItems.add(new RibbonItem(action, ""));
        }
        // -------------------------
