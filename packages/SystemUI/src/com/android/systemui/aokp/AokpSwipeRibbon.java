...
public class AokpSwipeRibbon extends LinearLayout {
    ...
    private boolean mText, mColorize, hasNavBarByDefault, NavBarEnabled, navAutoHide,
            mNavBarShowing, mVib, mToggleButtonLoc, mHideIme;
            ...
            for (String toggleIdent : userToggles) {
                try {
                    ...
                    if (networkController != null &&
                            toggle instanceof NetworkSignalChangedCallback) {
                        networkController
                                .addNetworkSignalChangedCallback(
                                        (NetworkSignalChangedCallback) toggle);
                        networkController
                                .notifySignalsChangedCallbacks(
                                        (NetworkSignalChangedCallback) toggle);
                    }

                    if (bluetoothController != null &&
                            toggle instanceof BluetoothStateChangeCallback) {
                        bluetoothController
                    ...
                    if (batteryController != null && toggle instanceof BatteryStateChangeCallback) {
                        batteryController
                                .addStateChangedCallback((BatteryStateChangeCallback) toggle);
    ...
    private void addToggleManagers() {
        ...
        LinearLayout.LayoutParams lp =
                new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, padding);
    ...
    private void addToogleButton() {
        ...
        mTogglesText.setOnClickListener(new OnClickListener() {
            ...
            public final void onClick(View v) {
                ...
                if (flipped) {
                    PlayAnim(mRibbonSV, mTogglesSV,
                            mContext.getResources().getDrawable(R.drawable.ribbon_toggles_icon),
                            mContext.getResources().getString(R.string.toggles));
                } else {
                    PlayAnim(mTogglesSV, mRibbonSV,
                            mContext.getResources().getDrawable(R.drawable.ribbon_icon),
    ...
    public void PlayAnim(final ScrollView in, final ScrollView out, final Drawable newIcon,
                         final String text) {
        if (mRibbon != null) {
            ...
            final Animation inIcon =
                    AnimationUtils.loadAnimation(mContext, com.android.internal.R.anim.fade_in);
            final Animation outIcon =
                    AnimationUtils.loadAnimation(mContext, com.android.internal.R.anim.fade_out);
    ...
    public void setDisabledFlags(int disabledFlags) {
        if (disabledFlags == mDisabledFlags) {
            return;
        }
        ...
        void observe() {
            ...
            for (int i = 0; i < 3; i++) {
                resolver.registerContentObserver(
                        Settings.System.getUriFor(Settings.System.ENABLE_RIBBON_LOCATION[i]), false,
                        this);
            }
            resolver.registerContentObserver(Settings.System.getUriFor(
    ...
    protected void updateSettings() {
        ...
        hasNavBarByDefault = mContext.getResources()
        ...
        mNavBarShowing =
                (NavBarEnabled || hasNavBarByDefault) && manualNavBarHide && !navHeightZero &&
                        !navAutoHide;
        mEnableSides[0] =
                mEnableSides[0] && (!(NavBarEnabled || hasNavBarByDefault) || !manualNavBarHide);

        addToggles(Settings.System
                .getArrayList(cr, Settings.System.SWIPE_RIBBON_TOGGLES[mLocationNumber]));
    ...
    public class RibbonReceiver extends BroadcastReceiver {
        public static final String ACTION_TOGGLE_RIBBON =
                "com.android.systemui.ACTION_TOGGLE_RIBBON";
