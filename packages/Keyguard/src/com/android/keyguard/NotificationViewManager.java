    ...
    class Configuration extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_SHOW_ALWAYS), false, this);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_POCKET_MODE), false, this);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_HIDE_LOW_PRIORITY), false, this);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_HIDE_NON_CLEARABLE), false, this);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_DISMISS_ALL), false, this);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_EXPANDED_VIEW), false, this);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_FORCE_EXPANDED_VIEW), false, this);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_WAKE_ON_NOTIFICATION), false, this);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_HEIGHT), false, this);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_OFFSET_TOP), false, this);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_PRIVACY_MODE), false, this);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_EXCLUDED_APPS), false, this);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_COLOR), false, this);
        }
        ...
        private void updateSettings() {
            showAlways = Settings.AOKP.getInt(mContext.getContentResolver(),
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_SHOW_ALWAYS, showAlways ? 1 : 0) == 1;
            pocketMode = Settings.AOKP.getInt(mContext.getContentResolver(),
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_POCKET_MODE, pocketMode ? 1 : 0) == 1;
            hideLowPriority = Settings.AOKP.getInt(mContext.getContentResolver(),
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_HIDE_LOW_PRIORITY, hideLowPriority ? 1 : 0) == 1;
            hideNonClearable = Settings.AOKP.getInt(mContext.getContentResolver(),
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_HIDE_NON_CLEARABLE, hideNonClearable ? 1 : 0) == 1;
            dismissAll = Settings.AOKP.getInt(mContext.getContentResolver(),
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_DISMISS_ALL, dismissAll ? 1 : 0) == 1;
            privacyMode = Settings.AOKP.getInt(mContext.getContentResolver(),
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_PRIVACY_MODE, privacyMode ? 1 : 0) == 1;
            expandedView = Settings.AOKP.getInt(mContext.getContentResolver(),
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_EXPANDED_VIEW, expandedView ? 1 : 0) == 1
                    && !privacyMode;
            forceExpandedView = Settings.AOKP.getInt(mContext.getContentResolver(),
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_FORCE_EXPANDED_VIEW, forceExpandedView ? 1 : 0) == 1
                    && !privacyMode;
            wakeOnNotification = Settings.AOKP.getInt(mContext.getContentResolver(),
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_WAKE_ON_NOTIFICATION, wakeOnNotification ? 1 : 0) == 1;
            notificationsHeight = Settings.AOKP.getInt(mContext.getContentResolver(),
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_HEIGHT, notificationsHeight);
            offsetTop = Settings.AOKP.getFloat(mContext.getContentResolver(),
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_OFFSET_TOP, offsetTop);
            String excludedApps = Settings.AOKP.getString(mContext.getContentResolver(),
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_EXCLUDED_APPS);
            notificationColor = Settings.AOKP.getInt(mContext.getContentResolver(),
                    Settings.AOKP.LOCKSCREEN_NOTIFICATIONS_COLOR, notificationColor);
                ...
                if (!mIsScreenOn) {
                    if (event.values[0] >= ProximitySensor.getMaximumRange()) {
                        if (config.pocketMode && mTimeCovered != 0 && (config.showAlways || mHostView.getNotificationCount() > 0)
                                ...
                                && !QuietHoursHelper.inQuietHours(mContext, Settings.AOKP.QUIET_HOURS_DIM)) {
                            wakeDevice();
