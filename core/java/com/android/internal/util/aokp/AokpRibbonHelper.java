...
public class AokpRibbonHelper {
    ...
    public static final int HANDLE_WEIGHT = 2;
    public static final int HANDLE_HEIGHT = 3;
    public static final int HANDLE_OPACITY = 4;
    public static final int HANDLE_VIBRATE = 5;
    public static final int HANDLE_LOCATION = 6;
    public static final int LONG_SWIPE = 7;
