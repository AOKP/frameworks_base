...
public class AokpRibbonHelper {
    ...
    public static HorizontalScrollView getRibbon(Context mContext, String shortTargets, String longTargets, boolean text) {
        ...
        if (!TextUtils.isEmpty(shortTargets) && !TextUtils.isEmpty(longTargets)) {
            ...
            for (int i = 0; i < shortSplit.length; i++) {
                ...
                newTarget = new RibbonTarget(mContext, shortSplit[i], longSplit[i], text);
                if (newTarget != null) {
