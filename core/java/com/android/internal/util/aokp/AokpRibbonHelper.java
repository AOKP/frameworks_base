        ...
        if (length > 0 && (shortTargets.size() == longTargets.size())) {
            ...
            for (int i = 0; i < length; i++) {
                if (!TextUtils.isEmpty(shortTargets.get(i))) {
                    ...
                    newTarget = new RibbonTarget(mContext, shortTargets.get(i), longTargets.get(i), text, size);
                    if (newTarget != null) {
