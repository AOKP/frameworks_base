...
public class AwesomeConstants {
    ...
    public static final String ASSIST_ICON_METADATA_NAME =
    ...
    public static String getProperName(Context context, String actionstring) {
        // Will return a string for the associated action, but will need the caller's context to
        // get resources.
    ...
    public static Drawable getActionIcon(Context context, String actionstring) {
        // Will return a Drawable for the associated action, but will need the caller's context
        // to get resources.
        Resources res = context.getResources();
        Drawable value = null;
        AwesomeConstant action = fromString(actionstring);
        switch (action) {
            ...
            /*case ACTION_SCREENSHOT:
                value = getSystemUIDrawable(context,
                "com.android.systemui:drawable/ic_sysbar_screenshot");
                break;*/
            case ACTION_MENU:
                value = getSystemUIDrawable(context,
            ...
            case ACTION_WIDGETS:
                value = getSystemUIDrawable(context,
                        "com.android.systemui:drawable/ic_sysbar_widget");
                break;
            case ACTION_APP_WINDOW:
                value = getSystemUIDrawable(context,
                        "com.android.systemui:drawable/ic_sysbar_widget");
