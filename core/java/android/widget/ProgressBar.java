...
public class ProgressBar extends View {
    ...
    public ProgressBar(Context context, AttributeSet attrs, int defStyle, int styleRes) {
        ...
        if (String.valueOf(drawable).contains("android.graphics.drawable.AnimationDrawabl")) {
         boolean IsMirrorMode = Settings.AOKP.getInt(mContext.getContentResolver(),
                 Settings.AOKP.PROGRESSBAR_MIRROR, 1) == 1;
         boolean IsReversed = Settings.AOKP.getInt(mContext.getContentResolver(),
                 Settings.AOKP.PROGRESSBAR_REVERSE, 1) == 1;
         int tmpSpeed = Settings.AOKP.getInt(mContext.getContentResolver(),
                 Settings.AOKP.PROGRESSBAR_SPEED, 0);
         float Speed = ((float) tmpSpeed+1 ) / 10;
         int Width = Settings.AOKP.getInt(mContext.getContentResolver(),
                 Settings.AOKP.PROGRESSBAR_WIDTH, 4);
         int Length = Settings.AOKP.getInt(mContext.getContentResolver(),
                 Settings.AOKP.PROGRESSBAR_LENGTH, 10);
         int Count = Settings.AOKP.getInt(mContext.getContentResolver(),
                 Settings.AOKP.PROGRESSBAR_COUNT, 6);
         int Color1 = Settings.AOKP.getInt(mContext.getContentResolver(),
                 Settings.AOKP.PROGRESSBAR_COLOR_1, -1);
         int Color2 = Settings.AOKP.getInt(mContext.getContentResolver(),
                 Settings.AOKP.PROGRESSBAR_COLOR_2, -1);
         int Color3 = Settings.AOKP.getInt(mContext.getContentResolver(),
                 Settings.AOKP.PROGRESSBAR_COLOR_3, -1);
         int Color4 = Settings.AOKP.getInt(mContext.getContentResolver(),
                 Settings.AOKP.PROGRESSBAR_COLOR_4, -1);
