...
public class InputMethodService extends AbstractInputMethodService {
     ...
     */
        ...
        boolean fullScreenOverride = Settings.AOKP.getInt(getContentResolver(),
                Settings.AOKP.FULLSCREEN_KEYBOARD, 0) != 0;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (event.getKeyCode() == KeyEvent.KEYCODE_VOLUME_UP) {
            mVolumeKeyCursorControl = Settings.AOKP.getInt(getContentResolver(),
                    Settings.AOKP.VOLUME_KEY_CURSOR_CONTROL, 0);
