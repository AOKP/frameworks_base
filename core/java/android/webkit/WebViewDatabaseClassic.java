...
final class WebViewDatabaseClassic extends WebViewDatabase {
    ...
    void setHttpAuthUsernamePassword(String host, String realm, String username,
        ...
        synchronized (mHttpAuthLock) {
            ...
            c.put(HTTPAUTH_USERNAME_COL, Crypto.encrypt(host + realm, username);
            c.put(HTTPAUTH_PASSWORD_COL, Crypto.encrypt(host + realm, password);
    ...
    String[] getHttpAuthUsernamePassword(String host, String realm) {
        ...
        synchronized (mHttpAuthLock) {
            ...
            try {
                ...
                if (cursor.moveToFirst()) {
                    ret = new String[2];
                    ret[0] = Crypto.decrypt(host + realm, cursor.getString(
                            cursor.getColumnIndex(HTTPAUTH_USERNAME_COL));
                    ret[1] = Crypto.decrypt(host + realm, cursor.getString(
