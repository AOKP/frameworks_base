...
public class KeyguardViewMediator {
    ...
    /**
     * Does not turn on screen, held while a call to {@link KeyguardViewManager#wakeWhenReadyTq
     * (int)}
    ...
    public interface ViewMediatorCallback {
         ...
         *                      the only reason for this to be false is if the keyguard was
         *                      instructed
    ...
    public void onSystemReady() {
        ...
        synchronized (this) {
            ...
            if (mLockPatternUtils.usingBiometricWeak()
                ...
                if (DEBUG) {
                    Log.d(TAG, "suppressing biometric unlock during boot");
                }
    ...
    private void doKeyguardLaterLocked() {
        ...
        if (timeout <= 0) {
            ...
            if (DEBUG) {
                Log.d(TAG, "setting alarm to turn off keyguard, seq = "
    ...
    public void setKeyguardEnabled(boolean enabled) {
        synchronized (this) {
            ...
            if (!enabled && mShowing) {
                ...
                if (DEBUG) {
                    Log.d(TAG, "remembering to reshow, hiding keyguard, "
    ...
    private void handleWakeWhenReady(int keyCode) {
        synchronized (KeyguardViewMediator.this) {
            ...
            if (!mKeyguardViewManager.wakeWhenReadyTq(keyCode)) {
                ...
                Log.w(TAG,
                        "mKeyguardViewManager.wakeWhenReadyTq did not poke wake lock, " +
                                "so poke it ourselves");
                userActivity();
            }
