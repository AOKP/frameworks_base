...
final class UiModeManagerService extends IUiModeManager.Stub
    ...
    public UiModeManagerService(Context context, TwilightService twilight) {
         ...
         */
        mConfiguration.uiThemeMode = Settings.AOKP.getIntForUser(
                mContext.getContentResolver(),
                Settings.AOKP.UI_THEME_MODE, mContext.getResources().getInteger(
    ...
    private void updateUiThemeMode() {
        mUiThemeAutoMode = Settings.AOKP.getIntForUser(
                mContext.getContentResolver(),
                Settings.AOKP.UI_THEME_AUTO_MODE,
    ...
    private void sendConfigurationLocked() {
        if (mSetUiMode != mConfiguration.uiMode
            ...
            Settings.AOKP.putIntForUser(mContext.getContentResolver(),
                    Settings.AOKP.UI_THEME_MODE, mSetUiThemeMode,
                    UserHandle.USER_CURRENT);
