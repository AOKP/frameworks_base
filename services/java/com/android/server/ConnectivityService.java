...
public class ConnectivityService extends IConnectivityManager.Stub {
    ...
    private static final int DEFAULT_SAMPLING_INTERVAL_IN_SECONDS = (VDBG ? 30 : -1 );
    ...
    public ConnectivityService(Context context, INetworkManagementService netManager,
        ...
        String hostname = Settings.AOKP.getString(context.getContentResolver(),
                Settings.AOKP.DEVICE_HOSTNAME);
